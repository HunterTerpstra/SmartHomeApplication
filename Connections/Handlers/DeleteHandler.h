...
#ifndef INC_3307_DELETEHANDLER_H
#define INC_3307_DELETEHANDLER_H
...
public:
    ...
    /**
     * @brief Specifically handles Delete requests (remove node from system)
     * @author Ryan Chan
...
#endif //INC_3307_DELETEHANDLER_H
